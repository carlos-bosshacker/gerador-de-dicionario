...
if len(sys.argv) != 6:
    print("Uso: python3 script.py -w - arquivo.cap BSSID")
    sys.exit(1)
...
p = subprocess.Popen(['aircrack-ng', modo, dicionario, '-b', bssid, arquivo_cap], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
